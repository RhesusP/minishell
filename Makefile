...
#    Updated: 2023/07/21 16:40:04 by cbernot          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell
SRCS = ./srcs/main.c ./srcs/signals/signals.c ./srcs/signals/exec_signal.c ./srcs/structs/get_env.c ./srcs/structs/env_utils.c \
		./srcs/utils.c \
